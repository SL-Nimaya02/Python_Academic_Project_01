...
for i in range(Progress_length):
    File_name.write("Progress - {} , {} , {} ".format(Progress_list[u],Progress_list[u+1],Progress_list[u+2])+"\n")
    u = u + 3
...
for i in range(module_trailer_length):
    File_name.write("Progress (module trailer) - {} , {} , {}".format(module_trailer_list[v],module_trailer_list[v+1],module_trailer_list[v+2])+"\n")
    v = v + 3
...
for i in range(module_retriever_length):
    File_name.write("Module retriever - {} , {} , {}".format(module_retriever_list[w],(module_retriever_list[w+1]),module_retriever_list[w+2])+"\n")
    w = w + 3
...
for i in range(Exclude_length):
    File_name.write("Exclude - {} , {} , {}".format(Exclude_list[x],Exclude_list[x+1],Exclude_list[x+2])+"\n")
    x = x + 3

File_name.close()


File_name= open("textfile.txt","r")
